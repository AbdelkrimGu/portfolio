...
function Hero() {
  return (
    <>
      ...
      >
        <p className="text-xl mb-5">Hi, I'm Abdelkrim.</p>
        <h1 className="heroTitle inline-block max-w-2xl lg:max-w-4xl  w-auto relative text-5xl md:text-6xl lg:text-7xl tracking-tighter mb-10 font-bold heroShinyBg">
          I enjoy <span className="heroShiny1 text-fun-pink">building</span> and{" "}
          <span className="heroShiny2 text-fun-pink">designing</span> full web applications.
          
          <img
            className="sqD bottom-[-300px] -right-1/4 sm:right-[-20%] lg:bottom-[-220px] lg:right-[-120px] w-[400px]"
            style={{ animationDelay: "0.3s" }}
            src="/static/spring.svg"
          />
          <img
            className="sqD hidden sm:block bottom-[-220px] left-[-180px]"
            style={{ animationDelay: "0.4s" }}
            src="/static/Django_logo.svg"
          />
          <img
          ...
          />
          <img
            className="sqD left-[-35px] bottom-[-85px] sm:bottom-[-100px] sm:left-5 "
            style={{ animationDelay: "0.9s" }}
            src="/static/Socket-io.svg"
          />
        </h1>
        <ScrollLink
          activeClass="active"
